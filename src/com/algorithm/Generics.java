...
public class Generics<T> {
	...
	private static <T extends Comparable<T>> void getInput(T key) {
		...
		try {
			sc = new Scanner(new File("/Users/anushajs/eclipse-workspace/Yml-training/Algorithm_Programs/src/data/input.txt"));
	...
	public static void main(String[] args) {
		...
		String[] arr1 = { "apple", "orange", "jelly", "berry" };
		Integer[] arr2 = { 80, 90, 10, 6};
